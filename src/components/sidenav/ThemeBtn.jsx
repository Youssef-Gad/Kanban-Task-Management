...
function ThemeBtn() {
  ...
  return (
    <div className="mx-auto my-4 flex w-[14rem] items-center justify-around rounded-md bg-light-grey p-3 dark:bg-very-dark-grey">
      ...
      <div
        className="relative flex h-6 w-12 items-center rounded-full bg-main-purple"
        onClick={() => setDarkMode((e) => !e)}
      >
        <div
          className={`absolute ${darkMode ? "right-7" : "right-1"} h-4 w-4 rounded-full bg-white transition-all duration-300`}
        ></div>
      </div>
