...
function ThemeBtn() {
  ...
  return (
    <div className="mx-auto my-4 flex w-[14rem] items-center justify-around rounded-md bg-light-grey p-3">
      ...
      >
        <div
          className={`absolute ${dark ? "right-7" : "right-1"} h-4 w-4 rounded-full bg-white transition-all duration-300`}
        ></div>
      </div>
