    ...
    <header className="fixed left-0 right-0 flex h-[6rem] select-none items-center bg-white dark:bg-dark-grey dark:text-white">
      {darkMode ? (
        <svg
          ...
          className="hidden border-b border-r pl-[2rem] pt-[2rem] dark:border-b-lines-dark dark:border-r-lines-dark sm:block"
        >
      ...
      <div className="flex flex-grow items-center justify-between border-b p-[1.1rem] dark:border-b-lines-dark sm:p-[1.3rem]">
        <div className="flex cursor-pointer items-center gap-3 sm:cursor-auto">
          <h1
            className="px-0 text-xl font-bold sm:px-6 sm:text-2xl"
